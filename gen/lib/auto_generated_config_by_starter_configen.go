...
func (inst * comFactory4pComOSSDriver) getterForFieldBMSelector (context application.InstanceContext) buckets0xc61cfb.Manager {
	...
	if !ok {
		...
		eb.Message("bad cast")
		eb.Set("com", "com0-aliyun0x8a6680.OSSDriver")
		eb.Set("field", "BM")
		eb.Set("type1", "?")
...
//getterForFieldBMSelector
func (inst * comFactory4pComBOSDriver) getterForFieldBMSelector (context application.InstanceContext) buckets0xc61cfb.Manager {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com1-baidu0xa9ed2f.BOSDriver")
		eb.Set("field", "BM")
		eb.Set("type1", "?")
		eb.Set("type2", "buckets0xc61cfb.Manager")
		context.HandleError(eb.Create())
...
//getterForFieldBMSelector
func (inst * comFactory4pComOBSDriver) getterForFieldBMSelector (context application.InstanceContext) buckets0xc61cfb.Manager {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com3-huawei0xcc0ad2.OBSDriver")
		eb.Set("field", "BM")
		eb.Set("type1", "?")
		eb.Set("type2", "buckets0xc61cfb.Manager")
		context.HandleError(eb.Create())
...
//getterForFieldBMSelector
func (inst * comFactory4pComCOSDriver) getterForFieldBMSelector (context application.InstanceContext) buckets0xc61cfb.Manager {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com4-qq0x13bfdf.COSDriver")
		eb.Set("field", "BM")
		eb.Set("type1", "?")
		eb.Set("type2", "buckets0xc61cfb.Manager")
		context.HandleError(eb.Create())
