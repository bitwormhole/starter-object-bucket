...
func autoGenConfig(cb application.ConfigBuilder) error {
	...
	// component: com2-demo0xbcc745.DemoRunner
	cominfobuilder.Next()
	cominfobuilder.ID("com2-demo0xbcc745.DemoRunner").Class("life").Aliases("").Scope("")
...
// comFactory4pComDemoRunner : the factory of component: com2-demo0xbcc745.DemoRunner
...
func (inst * comFactory4pComDemoRunner) getterForFieldDemo1Selector (context application.InstanceContext) *demo0xbcc745.Demo1 {
	...
	if !ok {
		eb := &util.ErrorBuilder{}
		eb.Message("bad cast")
		eb.Set("com", "com2-demo0xbcc745.DemoRunner")
		eb.Set("field", "Demo1")
		eb.Set("type1", "?")
